...
if upload_option == "Upload Data":
    ...
    dataset_name = st.sidebar.selectbox("Choose an example dataset", ["titanic", "tips", "iris"])
...
if 'data' in locals():
    ...
    if features and target:
        ...
        if problem_type == "Regression":
            model_choice = st.sidebar.selectbox("Choose a model", ["Linear Regression", "Decision Tree Regressor", "Random Forest Regressor", "Support Vector Regressor"])
            ...
            model_choice = st.sidebar.selectbox("Choose a model", ["Logistic Regression", "Decision Tree Classifier", "Random Forest Classifier", "Support Vector Classifier"])
